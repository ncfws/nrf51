...
// GPIO Pins
static uint32_t EPD_MOSI_PIN = 23;
static uint32_t EPD_SCLK_PIN = 24;
static uint32_t EPD_CS_PIN = 25;
static uint32_t EPD_DC_PIN = 26;
static uint32_t EPD_RST_PIN = 27;
static uint32_t EPD_BUSY_PIN = 28;
static uint32_t EPD_BS_PIN = 29;
